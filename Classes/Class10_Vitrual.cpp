...
public:
	...
	void print() const override /*std::cout<<"явным способ укаываем, что функция переопределена(если не указать, то компилятор будет считать что нужно скрывать функцию)"<<std::endl*/
	{
		Person::print();
